    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 overflow-y-auto relative">
        ...
        <motion.div
          ...
          className="w-full max-w-[440px] p-6 sm:p-8 rounded-3xl bg-white/70 dark:bg-slate-900/55 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/60 shadow-xl relative overflow-hidden animate-fade-in"
        >
          {/* Inner glows */}
          ...
          <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6 relative z-10">
            ...
            <Link to="/sign-in" className="text-primary-600 dark:text-primary-400 font-bold hover:underline">
              Sign in
            </Link>
          </p>
        </motion.div>
