      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Sign in to your RePlate account to continue.</p>
          </div>

          {/* Clerk form — header hidden, only renders the form */}
          <SignIn
            routing="path"
            path="/sign-in"
            signUpUrl="/sign-up"
